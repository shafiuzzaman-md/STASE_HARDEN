...
!if $(SMM_REQUIRE) == TRUE
  OvmfPkg/HwAlarm/DxeHwAlarm.inf
  OvmfPkg/HwLight/DxeLight.inf
  OvmfPkg/HwLight/SmmLight.inf
  OvmfPkg/B2SmiDispatch/B2SmiDispatch.inf
...
!if $(SMM_REQUIRE) == TRUE
  ...
  OvmfPkg/AccessRWVar/AccessRWVar.inf
  OvmfPkg/HwAlarm/SmmHwAlarm.inf
  OvmfPkg/RdtscControl/RdtscControl.inf
  OvmfPkg/HardwareHandler/HardwareHandler.inf
  OvmfPkg/ProcessFirmware/ProcessFirmware.inf
  OvmfPkg/HardwareManager/HardwareManager.inf
  OvmfPkg/KeyVault/KeyVault.inf
  ...
  MdeModulePkg/Universal/QueryVariableInfo/QueryVariableInfo.inf
